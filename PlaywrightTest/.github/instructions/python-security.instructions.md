...
gl = window.gl || {};
gl.snowplowStandardContext = {"schema":"iglu:com.gitlab/gitlab_standard/jsonschema/1-1-7","data":{"environment":"self-managed","source":"gitlab-rails","correlation_id":"01KM3CY8V8GHDS09D6HBQG7D07","extra":{},"user_id":null,"global_user_id":null,"user_type":null,"is_gitlab_team_member":null,"namespace_id":null,"ultimate_parent_namespace_id":null,"project_id":null,"feature_enabled_by_namespace_ids":null,"realm":"self-managed","deployment_type":"self-managed","context_generated_at":"2026-03-19T15:55:31.652Z"}};
...
<meta name="csrf-token" content="kUvFsGcQtZ-fHAW4QGQTsWTjnZya-TM1Trz-43ejNOZda-6Fg7SLiGLy4zu6j3YfHHLGfCdafu3eQjwNDORfHw" />
<meta name="csp-nonce" />
...
<form class="gl-show-field-errors" aria-live="assertive" data-testid="new_ldap_user" action="/users/auth/ldapmain/callback" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="jayUwv5X-euViwRzRmw0w4ESt3krNGrn89hH-ajO0LlBjL_3GvPH_Ghl4vC8h1Ft-YPsmZaXJz9jJoUX04m7QA" autocomplete="off" /><div class="form-group">
...
<form action="/users/sign_in" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="S9H4GbyiKeMKSN0tkTXIVpX-8OtRNUBO--878nS-iwiH8dMsWAYX9PemO65r3q347W-rC-yWDZZrEfkcD_ng8Q" autocomplete="off" /><input data-js-name="login" autocomplete="off" type="hidden" name="user[login]" id="user_login" />
