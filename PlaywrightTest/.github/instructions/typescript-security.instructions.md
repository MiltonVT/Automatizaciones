...
gl = window.gl || {};
gl.snowplowStandardContext = {"schema":"iglu:com.gitlab/gitlab_standard/jsonschema/1-1-7","data":{"environment":"self-managed","source":"gitlab-rails","correlation_id":"01KM3D85FAWHWSY3S76S1KEPXP","extra":{},"user_id":null,"global_user_id":null,"user_type":null,"is_gitlab_team_member":null,"namespace_id":null,"ultimate_parent_namespace_id":null,"project_id":null,"feature_enabled_by_namespace_ids":null,"realm":"self-managed","deployment_type":"self-managed","context_generated_at":"2026-03-19T16:00:55.862Z"}};
...
<meta name="csrf-token" content="q7jPDFsafDIN7AdqeLMHDC0sJJtr2G_-M6A2zW3UYq5JM1O3RAj83cRr1ptfxvLXWrC2qklLj5gshiyCXiadVA" />
<meta name="csp-nonce" />
...
<form class="gl-show-field-errors" aria-live="assertive" data-testid="new_ldap_user" action="/users/auth/ldapmain/callback" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="ZIbxgRpcsBYG_d4Sg4BnkBOd-GNx8hRZeVveTyo5g1yGDW06BU4w-c96D-Ok9ZJLZAFqUlNh9D9mfcQAGct8pg" autocomplete="off" /><div class="form-group">
...
<form action="/users/sign_in" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="qWDvB34MkJU8zQg1FXGTYODWFh3Tkt6BB8s_iy7iYq1L63O8YR4QevVK2cQyBGa7l0qELPEBPucY7SXEHRCdVw" autocomplete="off" /><input data-js-name="login" autocomplete="off" type="hidden" name="user[login]" id="user_login" />
